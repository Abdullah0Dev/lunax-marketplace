...
const MangeDiscount = () => {
  ...
  const { deleteDiscount } = useDiscountManagement();
  ...
  const renderDiscountCard = ({ item }) => {
    ...
    return (
      <View style={styles.discountCard}>
        <Image
          source={{
            uri: product?.cover_image || "https://via.placeholder.com/100",
          }}
  ...
  return (
      <View style={styles.container}>
        ...
        {/* Header */}
        <LinearGradient colors={["#11a1a1", "#f9fafb"]} style={[styles.header, { paddingTop: top +  hp("2%") }]}>
          <TouchableOpacity
            onPress={() => router.back()}
          ...
          {discounts.length > 0 ? (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptySubtext}>
                Tap a percentage above to create one
              </Text>
            </View>
          )}
        </View>
        ...
        <Modal visible={deleteModal} transparent animationType="fade">
          <View style={[styles.modalOverlay]}>
            <BlurView intensity={3} tint="dark" style={styles.deleteModal}>
              ...
              <Text style={styles.deleteTitle}>Delete Discount?</Text>
                ...
                <View style={styles.modalContent}>
                  <View style={styles.modalHeader}>
                    <Text style={styles.modalTitle}>
                      Create {selectedDiscount}% Discount
                    </Text>
