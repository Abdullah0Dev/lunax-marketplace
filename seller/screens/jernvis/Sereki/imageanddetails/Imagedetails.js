...
export default function ProductManagement() {
  ...
  const handleSaveProduct = async () => {
    ...
    setIsSaving(true); // Add this state
    ...
    try {
      ...
      // Upload all images at once if there are any
      if (imagesToUpload.length > 0) {
        console.log(`Uploading ${imagesToUpload.length} images:`, imagesToUpload);
      ...
      // Prepare product data with URLs
      const productData = {
        store_id: STORE_ID,
        name: {
          kurdish: kurdishName,
  ...
  const renderProductCard = ({ item }) => (
    ...
    >
      <Image
        ...
        defaultSource={require("../../../../assets/k15.webp")}
      />
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptySubtext}>Tap the button above to add your first product</Text>
            </View>
          }
        />
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.deleteModal}>
              ...
              <Text style={styles.deleteMessage}>
                Are you sure you want to delete "{selectedProduct?.name?.english}"?
