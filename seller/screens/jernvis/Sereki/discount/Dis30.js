...
export default function Dis30() {
  ...
  const getDiscountedPrice = () => {
    ...
    return (num * 0.70).toFixed(3); // 40% discount
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.uploadButton} onPress={() => setModalVisible(true)}>
        <Image  source={require("../../../../assets/m11.png")} style={{ width: wp("20%"), height: hp("8%") }}/>
        <Text style={styles.uploadText}>Discount 30%</Text>
      </TouchableOpacity>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <Text style={styles.label}>Price after 30% discount</Text>
