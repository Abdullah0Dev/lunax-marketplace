...
export default function Dis15() {
  ...
  const getDiscountedPrice = () => {
    ...
    return (num * 0.85).toFixed(3); // 40% discount
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.uploadButton} onPress={() => setModalVisible(true)}>
        <Image source={{ uri: 'https://static.vecteezy.com/system/resources/previews/035/116/431/non_2x/discount-15-percent-luxury-gold-and-red-offer-in-3d-suitable-for-promotions-for-christmas-chinese-new-years-and-ramadhan-sale-free-png.png' }} style={{ width: wp("20%"), height: hp("8%") }}/>
        <Text style={styles.uploadText}>Discount 15%</Text>
      </TouchableOpacity>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <Text style={styles.label}>Price after 15% discount</Text>
