...
export default function Dis10() {
  ...
  const getDiscountedPrice = () => {
    ...
    return (num * 0.90).toFixed(3); // 40% discount
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.uploadButton} onPress={() => setModalVisible(true)}>
        <Image source={{ uri: 'https://cdn3d.iconscout.com/3d/premium/thumb/10-percent-discount-3d-icon-png-download-5522836.png' }} style={{ width: wp("20%"), height: hp("8%") }}/>
        <Text style={styles.uploadText}>Discount 10%</Text>
      </TouchableOpacity>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <Text style={styles.label}>Price after 10% discount</Text>
