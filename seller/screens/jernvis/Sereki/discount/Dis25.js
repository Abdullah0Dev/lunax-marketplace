...
export default function Dis25() {
  ...
  const getDiscountedPrice = () => {
    ...
    return (num * 0.75).toFixed(3); // 40% discount
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.uploadButton} onPress={() => setModalVisible(true)}>
        <Image  source={{ uri: 'https://static.vecteezy.com/system/resources/thumbnails/024/326/134/small/promotion-3d-render-png.png' }} style={{ width: wp("20%"), height: hp("8%") }}/>
        <Text style={styles.uploadText}>Discount 25%</Text>
      </TouchableOpacity>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <Text style={styles.label}>Price after 25% discount</Text>
