...
export default function Dis35() {
  ...
  const getDiscountedPrice = () => {
    ...
    return (num * 0.65).toFixed(3); // 40% discount
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.uploadButton} onPress={() => setModalVisible(true)}>
        <Image  source={{ uri: 'https://cdn3d.iconscout.com/3d/premium/thumb/35-percentage-off-3d-icon-png-download-5873628.png' }} style={{ width: wp("20%"), height: hp("8%") }}/>
        <Text style={styles.uploadText}>Discount 35%</Text>
      </TouchableOpacity>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <Text style={styles.label}>Price after 35% discount</Text>
