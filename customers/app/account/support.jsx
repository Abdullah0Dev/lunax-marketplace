    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.description}>
          تو وەک بازرگان ئەگەر تە بڤێت بەژدارببی دناڤا ئەپلیکەیشنا LUNAX داکو
          ددەمەکێ کورت دا هەمی کەس بەرهەمێن تە ببین و داخاز بکەن پەیوەندیێ بمە
          بکە. یان هەر داخوازیەکا تە هەبیت یان هاریکاریەک ئەم دگەل تە داینە
        </Text>
